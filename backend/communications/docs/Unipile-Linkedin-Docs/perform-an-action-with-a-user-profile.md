...
```json
{
  "openapi": "3.0.0",
  "paths": {
    "/api/v1/linkedin/user/{user_id}": {
      "post": {
        "operationId": "LinkedinController_performActionOnMember",
        "summary": "Perform an action with a user profile",
        "description": "Add a candidate to a Recruiter pipeline, save a Sales Navigator lead, etc.",
        "parameters": [
          {
            "name": "user_id",
            "required": true,
            "in": "path",
            "description": "The ID of the user (ACw... for Sales Navigator or AEM... for Recruiter).",
            "schema": {
              "type": "string"
            }
          }
          ...
          "content": {
            "application/json": {
              "schema": {
                "anyOf": [
                  {
                    "title": "Recruiter - Add candidate to pipeline",
                    "type": "object",
                    "properties": {
                      "account_id": {
                        "title": "UniqueId",
                      ...
                      "stage": {
                        "description": "The default value for the stage will be uncontacted.",
                        "type": "string",
                        "enum": [
                          "UNCONTACTED",
                          "CONTACTED",
                  ...
                  {
                    "title": "Sales Navigator - Save lead",
                    "type": "object",
                    "properties": {
                      "account_id": {
                        "title": "UniqueId",
