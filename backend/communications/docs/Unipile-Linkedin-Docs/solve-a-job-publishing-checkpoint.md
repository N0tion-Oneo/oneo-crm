...
```json
{
  "openapi": "3.0.0",
  "paths": {
    "/api/v1/linkedin/jobs/{draft_id}/checkpoint": {
      "post": {
        "operationId": "LinkedinController_solveCheckpoint",
        "summary": "Solve a job publishing checkpoint",
        "description": "Solve a checkpoint to verify your member privilegies.",
        "parameters": [
          {
            "name": "draft_id",
            "required": true,
