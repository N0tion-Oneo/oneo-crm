...
```json
{
  ...
  "paths": {
    "/api/v1/chat_attendees/{attendee_id}/chats": {
      "get": {
        "operationId": "ChatAttendeesController_listChatsByAttendee",
        "x-readme": {
          "code-samples": [
            {
              "language": "node",
        ...
        "parameters": [
          ...
          },
          {
            ...
            "required": true,
            "in": "path",
            "description": "The Unipile ID OR provider_id of the attendee. Can be a comma-separated list of multiple ids.",
            "schema": {
              "type": "string"
            }
          }
