...
```json
{
  ...
  "paths": {
    "/api/v1/posts/reaction": {
      "post": {
        "operationId": "PostsController_addPostReaction",
        "x-readme": {
          "code-samples": [
            {
              "language": "node",
            ...
            "application/json": {
              "schema": {
                ...
                "properties": {
                  ...
                  "post_id": {
                    "minLength": 1,
                    "description": "The id of the post to send a reaction to. <br>      `Linkedin`: Please check the Post data schema to get the right id (Social id). <br>      `Instagram` Please use the provider_id",
                    "type": "string"
                  },
                  "comment_id": {
                    "minLength": 1,
