...
```json
{
  ...
  "paths": {
    "/api/v1/posts/{post_id}/comments": {
      "post": {
        "operationId": "PostsController_sendComment",
        "x-readme": {
          "code-samples": [
            {
              "language": "node",
        ...
        "parameters": [
          {
            ...
            "required": true,
            "in": "path",
            "description": "The ID of the associated post. <br>        `Linkedin` The SOCIAL id of the post to comment. Please check the Linkedin Post data schema to get the right id. <br>        `Instagram` Post short code dont work on this route, please use the provider_id instead.",
            "schema": {
              "type": "string"
            }
          }
