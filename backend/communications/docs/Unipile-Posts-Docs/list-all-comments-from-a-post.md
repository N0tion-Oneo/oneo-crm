...
```json
{
  ...
  "paths": {
    "/api/v1/posts/{post_id}/comments": {
      "get": {
        "operationId": "PostsController_listAllComments",
        "x-readme": {
          "code-samples": [
            {
              "language": "node",
        ...
        "parameters": [
          ...
          },
          {
            ...
            "required": true,
            "in": "path",
            "description": "The ID of the associated post. <br>        `Linkedin`: this must be the social ID provided in the GET post route response. <br>        `Instagram`: Need to use the **provider_id**. Short code cannot be used here (***www.instagram.com/p/SHORTCODE***)",
            "schema": {
              "type": "string"
            }
          }
