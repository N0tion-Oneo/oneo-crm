...
# RecordCommunicationLink has been removed - using participant-based linking instead
# Conversations are now linked to records through Participant.contact_record
