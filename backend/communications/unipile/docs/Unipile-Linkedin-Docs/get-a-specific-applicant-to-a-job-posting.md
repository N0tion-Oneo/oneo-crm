...
```json
{
  "openapi": "3.0.0",
  "paths": {
    "/api/v1/linkedin/jobs/applicants/{applicant_id}": {
      "get": {
        "operationId": "LinkedinController_getJobApplicant",
        "summary": "Get a specific applicant to a job posting",
        "description": "Retrieve the details of a user that has applied to a given offer.",
        "parameters": [
          {
            "name": "account_id",
            "required": true,
