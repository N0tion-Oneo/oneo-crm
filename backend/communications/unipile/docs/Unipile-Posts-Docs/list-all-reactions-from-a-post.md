...
```json
{
  ...
  "paths": {
    "/api/v1/posts/{post_id}/reactions": {
      "get": {
        "operationId": "PostsController_listAllReactions",
        "x-readme": {
          "code-samples": [
            {
              "language": "node",
        ...
        "parameters": [
          ...
          },
          {
            ...
            "required": true,
            "in": "path",
            "description": "The ID of the associated post. <br>        `Linkedin`: this must be the social ID provided in the GET post route response.",
            "schema": {
              "type": "string"
            }
          }
