...
class WorkflowApprovalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'execution', 'title', 'description',
            'requested_by', 'assigned_to', 'created_at', 'approval_data',
            'status', 'timeout_at', 'escalation_rules', 'responded_at', 
            'responded_by', 'response_comments', 'is_pending'
        ]
        read_only_fields = [
            'id', 'execution', 'requested_by', 'created_at',
            'responded_at', 'responded_by', 'is_pending'
        ]
