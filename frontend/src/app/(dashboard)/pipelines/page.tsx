      ...
      <div className="flex items-center justify-center h-full bg-gray-50 dark:bg-gray-900">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Select a pipeline from the sidebar to manage its configuration, or create a new pipeline to get started.
          </p>
          
          <div className="space-y-4">
            <button
              onClick={() => setShowTemplateLoader(true)}
              className="w-full px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium flex items-center justify-center"
            >
