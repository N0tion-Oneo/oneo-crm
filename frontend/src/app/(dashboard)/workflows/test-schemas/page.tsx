...
const TEST_NODE_TYPES = [
  ...
  { type: WorkflowNodeType.MERGE_DATA, label: 'Merge Data', category: 'Data' },
  { type: WorkflowNodeType.GENERATE_FORM_LINK, label: 'Generate Form Link', category: 'Data' },
  // AI operations
  ...
  { type: WorkflowNodeType.UNIPILE_SYNC_MESSAGES, label: 'Sync Messages', category: 'Communication' },
  { type: WorkflowNodeType.LOG_COMMUNICATION, label: 'Log Communication', category: 'Communication' },
  { type: WorkflowNodeType.ANALYZE_COMMUNICATION, label: 'Analyze Communication', category: 'Communication' },
  { type: WorkflowNodeType.SCORE_ENGAGEMENT, label: 'Score Engagement', category: 'Communication' },
  // Control flow
  ...
  { type: WorkflowNodeType.WAIT_FOR_RESPONSE, label: 'Wait for Response', category: 'Control' },
  { type: WorkflowNodeType.WAIT_FOR_RECORD_EVENT, label: 'Wait for Event', category: 'Control' },
  { type: WorkflowNodeType.WAIT_FOR_CONDITION, label: 'Wait for Condition', category: 'Control' },
  { type: WorkflowNodeType.WORKFLOW_LOOP_CONTROLLER, label: 'Loop Controller', category: 'Control' },
  { type: WorkflowNodeType.WORKFLOW_LOOP_BREAKER, label: 'Break Loop', category: 'Control' },
  { type: WorkflowNodeType.CONVERSATION_STATE, label: 'Conversation State', category: 'Control' },
  { type: WorkflowNodeType.APPROVAL, label: 'Approval', category: 'Control' },
  // External
  ...
  { type: WorkflowNodeType.TASK_NOTIFY, label: 'Send Notification', category: 'External' },
  { type: WorkflowNodeType.SUB_WORKFLOW, label: 'Run Sub-Workflow', category: 'External' },
  // CRM
