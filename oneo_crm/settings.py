...
ALLOWED_HOSTS = [
    'localhost', 
    '127.0.0.1',
    '*.localhost',  # Wildcard for development subdomains
...
TENANT_APPS = [
    ...
    'strawberry.django',  # Modern GraphQL support with async
...
# URL configuration - temporarily use same URLs for both to test  
ROOT_URLCONF = 'oneo_crm.urls_tenants'
PUBLIC_SCHEMA_URLCONF = 'oneo_crm.urls_tenants'
...
STRAWBERRY_DJANGO = {
    'SCHEMA_MODULE': 'api.graphql.strawberry_schema',
