# Generated by Django 5.0 on 2025-07-29 06:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('field_type', models.CharField(choices=[('text', 'text'), ('textarea', 'textarea'), ('number', 'number'), ('decimal', 'decimal'), ('boolean', 'boolean'), ('date', 'date'), ('datetime', 'datetime'), ('time', 'time'), ('select', 'select'), ('multiselect', 'multiselect'), ('radio', 'radio'), ('checkbox', 'checkbox'), ('email', 'email'), ('phone', 'phone'), ('url', 'url'), ('color', 'color'), ('file', 'file'), ('image', 'image'), ('relation', 'relation'), ('user', 'user'), ('ai_field', 'ai_field'), ('computed', 'computed'), ('formula', 'formula')], max_length=50)),
