...
from .auth import authenticate_websocket_session, extract_session_from_scope, check_user_permissions
import logging
import time
...
class BaseRealtimeConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        # Try to authenticate from scope first (if session in cookies)
