# Generated by Django 5.0 on 2025-07-29 06:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source_pipeline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outgoing_relationships', to='pipelines.pipeline')),
        ...
        migrations.AddIndex(
            model_name='relationship',
            index=models.Index(condition=models.Q(('is_deleted', False)), fields=['source_pipeline', 'source_record_id', 'relationship_type'], name='idx_rel_src_type_active'),
        ),
        migrations.AddIndex(
            model_name='relationship',
            index=models.Index(condition=models.Q(('is_deleted', False)), fields=['target_pipeline', 'target_record_id', 'relationship_type'], name='idx_rel_tgt_type_active'),
        ),
