...
class TriggerHandlerFactory:
    ...
    def _register_handlers(self):
        ...
        try:
            ...
            from .field_handlers import FieldChangedHandler
            ...
            from .status_handlers import StatusChangeHandler, PipelineStageHandler
    ...
    def _register_basic_handlers(self):
        ...
        basic_handlers = [
            ...
            BasicRecordHandler(WorkflowTriggerType.FIELD_CHANGED),
    ...
    def get_handler_for_event(self, event: TriggerEvent) -> Optional[BaseTriggerHandler]:
        ...
        event_to_trigger_map = {
            ...
            'status_changed': WorkflowTriggerType.STATUS_CHANGED,
